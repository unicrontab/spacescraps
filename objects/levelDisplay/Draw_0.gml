...
if (instance_exists(oPlayer2)) draw_text_transformed_color(oPlayer2.x, oPlayer2.y, "LEVEL " + string(oGameController.currentLevel),image_alpha,image_alpha, image_angle, pointColor, pointColor, pointColor, pointColor, image_alpha);
